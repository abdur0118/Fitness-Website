...
const trainerName = trainerNameElement.innerText;

const memberNameElement = document.getElementById("memberName");
memberNameElement.innerText = sessionStorage.getItem('trainerViewingUser')
...
initialLoad.open('get','/trainer/initial-todo-load',true);
initialLoad.setRequestHeader('name', memberName);
...
list.addEventListener('click', function(e) {
  if(e.target && e.target.nodeName == "LI") {
    ...
    function newElement() {
      var li = document.createElement("li");
      var inputValue = document.getElementById("myInput").value + `(trainer)`;
      socket.emit('addTask',memberName,inputValue,'trainer');
        var t = document.createTextNode(inputValue);
        li.appendChild(t);
        if (inputValue === '') {
